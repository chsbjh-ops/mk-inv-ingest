...
==============================================================================
 ...
 ----------------------------------------------------------------------------
   ...
   유로존 국채금리(dataflow YC, G_N_A = '전체 국채'):
     1·2·3·5·7·10년 spot : YC / B.U2.EUR.4F.G_N_A.SV_C_YM.SR_{n}Y
...
INDICATORS = [
    ...
    (5,  "YC",  "B.U2.EUR.4F.G_N_A.SV_C_YM.SR_1Y",    "유로존 국채금리 1년"),
    (6,  "YC",  "B.U2.EUR.4F.G_N_A.SV_C_YM.SR_2Y",    "유로존 국채금리 2년"),
    (7,  "YC",  "B.U2.EUR.4F.G_N_A.SV_C_YM.SR_3Y",    "유로존 국채금리 3년"),
    (8,  "YC",  "B.U2.EUR.4F.G_N_A.SV_C_YM.SR_5Y",    "유로존 국채금리 5년"),
    (9,  "YC",  "B.U2.EUR.4F.G_N_A.SV_C_YM.SR_7Y",    "유로존 국채금리 7년"),
    (10, "YC",  "B.U2.EUR.4F.G_N_A.SV_C_YM.SR_10Y",   "유로존 국채금리 10년"),
]
